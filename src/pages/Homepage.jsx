        ...
        <div className="my-4 mb-8 !px-[20px] sm:!px-[50px] md:!px-[110px] p-8 rounded-md border border-primary pb-[120px]">
          ...
          >
            ...
            <Button
              ...
              size="large"
              htmlType="submit"
              className="secondary-btn rounded-none ml-auto"
            >
            ...
            <div className="mx-[60px] py-4 space-y-3 !text-[13px]">
              ...
              <div className="relative overflow-x-auto mb-6 mt-2 text-slate-800 font-normal space-y-[2px] !text-left">
                ...
                <div className="flex justify-between gap-4">
                  <div className="font-semibold space-y-1">
                    <h2 className="font-bold">
                      Детаљи апликације/ Application details
                    </h2>
                    <div className="flex gap-4">
                      <h2 className="bg-gray w-[280px] leading-[16px] p-1">
                        ид апликације/ <br />
                        Application ID
                      </h2>
                    ...
                    <h2 className="font-bold leading-[16px]">
                      Ово је да обавестите е-визу која је издата/ <br /> This is
                      to inform an e-visa issued to
                    </h2>
                ...
                <div className="font-semibold space-y-1">
                  ...
                  <div className="flex gap-4">
                    <h2 className="bg-gray w-[280px] p-1 leading-[16px]">
                      Категорија електронске визе / Category of electronic visa
                    </h2>
                    <p>РАД / WORK</p>
                  </div>
                  <div className="flex gap-4">
              ...
              <div className="text-[16px]">
                <div className="flex justify-between items-center gap-2 my-6">
                  ...
                  <div className="!font-semibold text-black text-left space-y-4">
                    ...
                    >
                      Молимо понесите ОВО обавештење ca собом И покажите
                      транспортну фирму ради провере е-визе.
                    </p>
                    ...
                    <p
                      ...
                      className="leading-[16px]"
                    >
                      Please bring this notification with you and show transport
                      company for a e-visa check.
                    </p>
